...
export class TablesComponent implements OnInit, OnDestroy {
  ...
  confirmerEnc() {
    ...
    // Marquer commandes SERVED via API
    const calls = orders
      .filter(o => ['SENT','PREPARING','READY'].includes(o.status))
      .map(o => this.api.updateOrderStatus(o.id, 'SERVED').toPromise());
