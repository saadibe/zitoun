...
export interface Order { id: number; tableNumber: number; status: string; items: OrderItem[]; total: number; createdAt: string; updatedAt?: string; paymentMethod?: string; paidAt?: string; dailyTicketNumber?: number; globalNote?: string; cancelledReason?: string; serverName?: string; }
