...
public class DataInitializer implements CommandLineRunner {
    ...
    // ── VERSION DU MENU ─────────────────────────────
    // Changer ce numéro UNIQUEMENT quand on veut forcer
    // une réinitialisation du menu (ex: nouveau menu client)
    private static final String MENU_VERSION = "laperla-v1";
    ...
    public void run(String... args) {
        ...
        // ── Menu : charger SEULEMENT si la base est vide ──
        // On ne supprime JAMAIS les données existantes
        // Les ajouts/modifs faits via admin sont préservés
        if (menuRepo.count() == 0) {
        ...
        // ── Tables : charger seulement si vides ──────
